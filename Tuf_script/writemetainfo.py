...
def create_metainfo_file(privatekeyfilename, publickeyfilename, new=False):
  ...
  file_path = os.path.join(basic_path, "writemetainfo_dir")
  ...
  for filename in os.listdir(file_path):
    ...
    filehash = get_file_hash(filename_path)
    ...
    if filename not in previous_entries:
      ...
      updatedlist.append(filename_path)
  ...
  outfo_path = os.path.join(file_path, "metainfo")
  outfo = file(outfo_path,"w")
